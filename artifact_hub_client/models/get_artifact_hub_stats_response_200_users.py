...
T = TypeVar("T", bound="GetArtifactHubStatsResponse200Users")


@attr.s(auto_attribs=True)
class GetArtifactHubStatsResponse200Users:
    """
    Attributes:
        total (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_artifact_hub_stats_response_200_users = cls(
            total=total,
            running_total=running_total,
        )

        get_artifact_hub_stats_response_200_users.additional_properties = d
        return get_artifact_hub_stats_response_200_users
