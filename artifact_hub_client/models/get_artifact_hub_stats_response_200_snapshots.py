...
T = TypeVar("T", bound="GetArtifactHubStatsResponse200Snapshots")


@attr.s(auto_attribs=True)
class GetArtifactHubStatsResponse200Snapshots:
    """
    Attributes:
        total (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_artifact_hub_stats_response_200_snapshots = cls(
            total=total,
            running_total=running_total,
            created_monthly=created_monthly,
        )

        get_artifact_hub_stats_response_200_snapshots.additional_properties = d
        return get_artifact_hub_stats_response_200_snapshots
